(function() {
    ...
    const modalHTML = `
        <div id="exchanger-modal">
            <div class="exchanger-content">
                ...
                <div class="exchanger-badge">VIP EXCHANGER</div>
                <h2 class="exchanger-title">Silver Exchange</h2>
                <p class="exchanger-subtitle">Convert your VIP chips into normal chips with a polished exchange.</p>
    ...
    upgradeBtn.addEventListener('click', () => {
        ...
        if (currentNormal < UPGRADE_COST) {
            return alert("You need 100,000,000 chips to unlock this upgrade.");
        }

        if (confirm("Spend 100,000,000 chips to upgrade the exchange and cut the wait to 5 minutes?")) {
