(function () {
    const DAILY_KEY = "sm-last-free-spin-date";
    const FREE_SPINS_KEY = "sm-free-spins-count";
    ...
    function patchSpinButton() {
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (!nextFreeLbl) {
                ...
                nextFreeLbl.style.color = "#f1c40fcf";
            ...
            freeSpinIndicator.style.background = "#f1c40f";
            ...
            function updateIndicators() {
                ...
                if (n > 0) {
                    freeSpinIndicator.textContent = `🎁 ${n} Free`;
                    ...
                    if (msRem > 0) {
                        nextFreeLbl.textContent = `Next Free Spin: ${formatDuration(msRem)}`;
                    } else {
                        grantDailyFreeSpins();
                        updateIndicators();
                    }
