(function () {
    const jackpotAudioPath = 'sfx/sm-jackpot.mp3';
    const specialBellJackpotPath = 'sfx/sm-3-bells.mp3';
    const insertCoinAudioPath = 'sfx/sm-click.mp3';
    const reelSpinAudioPath = 'sfx/sm-falling.mp3';
    const bgMusicAudioPath = 'sfx/sm-bgm.mp3';
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const isSlotMachinePage = window.location.pathname.endsWith('slot-machines.html') ||
                                  window.location.pathname.endsWith('/slot-machines.html');
    ...
    (function () {
        ...
        function patchSpin() {
            if (!window.spin || window.spin._smSfxPatched) return;
            ...
            window.spin._smSfxPatched = true;
        }
